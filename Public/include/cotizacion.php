    ...
    <section class="cotizacion">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-5">
                    <h1 class="tit_principal">¡Solicita tu cotización!</h1>
                    <p class="txt_principal">Nos encantará ayudarte a <b>invertir y ahorrar</b> inteligentemente.</p>
                    <ul class="cotizacion__list">
                        <li class="cotizacion__item"><a href="tel:7227024046"><i class="icon icon_whatsapp_y"></i>722 702 4046</a></li>
                        <li class="cotizacion__item"><a href="mailto:contacto@consol.com.mx"><i class="icon icon_mail_y"></i>contacto@consol.com.mx</a></li>
                        <li class="cotizacion__item"><a href="https://goo.gl/maps/7HcDQDwj6uPWJCUj9"><i class="icon icon_map_y"></i>Calle independencia 145, Santa Ana Tlapaltitlán, <br> Toluca Estado de México.</a></li>
                    </ul>
                </div>
                <div class="col-md-7">
