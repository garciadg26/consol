let formulario = document.getElementById('cotizacion');
//const formulario = document.getElementById('formulario');
const inputs = document.querySelectorAll('#cotizacion input');

const expresiones = {
    //comentario: /^[a-zA-Z0-9\_\-]{4,16}$/, // Letras, numeros, guion y guion_bajo
    nombre: /^[a-zA-ZÀ-ÖØ-öø-ÿ\s]{2,40}$/, // Letras y espacios, pueden llevar acentos.
