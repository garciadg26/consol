...
<body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-12">
                    <h1 class="tit_principal mb-5 section__title">¡Solicita tu cotización!</h1>
                    <div class="contacto__item home__photo3">
                    ...
                    <div class="contacto__item home__photo5">
                    ...
                    <div class="contacto__item home__photo7">
                ...
                <div class="col-lg-6 col-md-12 section__title">
                    <form class="formulario" id="formulario" action="">
                        ...
                        <div class="formulario__grupo" id="grupo__telefono">
                            ...
                            <p class="formulario__input-error">El teléfono solo puede contener numeros y el máximo son 12 dígitos.</p>
                        </div>
    ...
    ?>
    <script type="text/javascript" src="Public/js/formulario.js?ver=1.1.12"></script>
