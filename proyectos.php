                ...
                <div class="col-lg-4 col-md-6">
                    <div class="proyecto proyecto--cuarto">
                        <div class="proyecto__txt">
                            <span class="caption">Edomex</span>
                            <h5 class="tit_secundario">Instalación comercial</h5>
                            <p class="txt_principal">Floricultor sistema para cámara de refrigeración, 13 paneles 550 w potencia pico instalada 7.15 kw.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="proyecto proyecto--quinto">
                        <div class="proyecto__txt">
                            <span class="caption">Edomex</span>
                            <h5 class="tit_secundario">Instalación comercial</h5>
                            <p class="txt_principal">Cremería don Deme, sistema de 12 paneles solares de 550 w, potencia pico instalada 6.6 kw.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 offset-lg-1 col-md-6 offset-md-0">
                    <article class="cont_proceso">
                        <h1 class="tit_principal mb-4">Proceso de contratación.</h1>
                        <p class="txt_principal mb-4">Nuestra misión es <span class="contratacion--acent">ayudar</span> a crecer la economía de las pequeñas y grandes empresas locales, así como <b>implementar tecnología</b> para <span class="contratacion--acent">disminuir la contaminación</span> que se produce al utilizar energía eléctrica por los combustibles fósiles, manteniendo a nuestros <b>clientes</b> <span class="contratacion--acent">tranquilos y felices</span> por la inteligente decisión de invertir en sus hogares o negocios.</p>
                        <div class="btnc">
                            <a class="btnc__item btnc__item--principal" href="#coti">Agenda una cita</a>
                        </div>
                    </article>
